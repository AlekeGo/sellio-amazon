    ...
    <div style={{ maxWidth: 960, margin: '0 auto', padding: '0 1rem', paddingTop: '5.5rem' }}>
      <div style={{
        ...
        <div style={{ flex: 1, minWidth: 180 }}>
          <div style={{ fontSize: '0.625rem', fontWeight: 700, color: 'rgba(83,58,253,0.6)', textTransform: 'uppercase', letterSpacing: '0.1em', marginBottom: '0.25rem' }}>
            Your Sellio Workspace
          </div>
          <p style={{ fontSize: '0.9375rem', fontWeight: 700, color: 'var(--dp-ink)', margin: 0, letterSpacing: '-0.02em' }}>
            {user?.full_name ? `Welcome back, ${user.full_name.split(' ')[0]}` : 'Welcome back'}
          </p>
        </div>
        <div style={{ display: 'flex', gap: '0.625rem', flexWrap: 'wrap', alignItems: 'center' }}>
          <Link to="/dashboard/new-audit" className="dp-btn-primary" style={{ padding: '0.5rem 1rem', fontSize: '0.8125rem' }}>
            <Zap size={13} />
            New Audit
          </Link>
          <Link to="/dashboard" className="dp-btn-ghost" style={{ padding: '0.5rem 1rem', fontSize: '0.8125rem' }}>
            <LayoutDashboard size={13} />
            Dashboard
          </Link>
          <Link to="/dashboard/billing" className="dp-btn-ghost" style={{ padding: '0.5rem 1rem', fontSize: '0.8125rem' }}>
            <CreditCard size={13} />
            Billing
          </Link>
        </div>
